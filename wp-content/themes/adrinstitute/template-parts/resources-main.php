<div class="resources_content_area">
    <div class="resources_tab">
        <div class="tab_wrapper">
            ...
            include_once "common-kids-corner-resources/adri-blog-menu.php";
            include_once "common-kids-corner-resources/instructional-videos-menu.php";
            include_once "common-kids-corner-resources/community-menu.php";
    ...
    include_once "common-kids-corner-resources/adri-blog-content.php";
    include_once "common-kids-corner-resources/instructional-videos-content.php";
    include_once "common-kids-corner-resources/community-content.php";
