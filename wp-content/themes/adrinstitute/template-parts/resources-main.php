<div class="resources_content_area">
    <div class="resources_tab">
        <div class="tab_wrapper">
            ...
            <?php include_once "common-kids-corner-resources/adri-blog-menu.php" ?>
            <?php include_once "common-kids-corner-resources/instructional-videos-menu.php" ?>
            <?php include_once "common-kids-corner-resources/community-menu.php" ?>
    ...
    <?php include_once "common-kids-corner-resources/community-content.php" ?>
